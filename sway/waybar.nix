{
  ...
  settings = {
    mainbar = {
      ...
      modules-center = [ "custom/audio_idle_inhibitor" "sway/workspaces" ];
      modules-right = [ "idle_inhibitor" "memory" "pulseaudio" "sway/language" "battery" "tray" "clock" "custom/notification" ];
      "custom/notification" = {
        tooltip = false;
        format = "󰐥";
        format-icons = {
